...
var Html = function(options) {
  ...
  // Mkdir that ignores any errors
    ...
    if(options.reportSubDirectory != null) {
      mkdirIgnore(options.outputDirectory + "/cover/html/" + options.reportSubDirectory, 0777);
    }
    ...
    var outputFile = options.outputDirectory + "/cover/html/" + outputFilename;
    if(options.reportSubDirectory != null) {
      outputFile = options.outputDirectory + "/cover/html/" + options.reportSubDirectory + "/" + outputFilename;
    }
