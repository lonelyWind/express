...
var Html = function(options) {
 ...
 //  // Mkdir that ignores any errors
	// var mkdirIgnore = function(directory, mode) {
	...
	// var setup = function() {
 //    // Make directories
	// 	mkdirIgnore(options.outputDirectory, 0777);
 //    mkdirIgnore(options.outputDirectory + "/cover", 0777);    
	// 	mkdirIgnore(options.outputDirectory + "/cover/html", 0777);    
 ...
 //  	console.log(options.outputDirectory + "/cover/html/" + outputFilename);
 //  	// Write the file out
 //  	fs.writeFileSync(options.outputDirectory + "/cover/html/" + outputFilename, html);
	// }
}
